...
\begin{table}[h]
    ...
    \begin{tabular}{llrr}
    \toprule
    \textbf{Sector} & \textbf{Period} & \textbf{N} & \textbf{Rate} \\
    \midrule
    Electronics Retail (JP) & 2018--2024 & 20 & 90.0\% \\
    Food Service (JP) & 2018--2024 & 20 & 92.5\% \\
    Telecom (India) & 2016--2024 & 20 & 90.0\% \\
    FMCG (India) & 2017--2025 & 20 & 95.0\% \\
    \midrule
...
\begin{figure}[htbp]
    ...
    \caption{Action-Response Heatmap: Japanese Electronics Retail and Food Service. Rows represent initiating action types, and columns represent response types. Cell color intensity indicates frequency (darker = more observations). The strong diagonal density demonstrates symmetric tit-for-tat behavior: firms predominantly match the type of competitive action they face.}
    \label{fig:heatmap}
\end{figure}
